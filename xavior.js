...
⭔ *Url* : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
                ...
                resultss = anu[Math.floor(Math.random() * anu.length)]
                xavior.sendMessage(m.chat, { image: { url: resultss }, caption: '⭔ Media Url : '+result }, { quoted: m })
            }
            break
